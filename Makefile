...
receptor_dynamics.o immune_submodels.o pharmacodynamics_submodel.o epithelium_submodel.o
...
pharmacodynamics_submodel.o: ./custom_modules/pharmacodynamics_submodel.cpp
	$(COMPILE_COMMAND) -c ./custom_modules/pharmacodynamics_submodel.cpp 
...
jpeg: 
	magick mogrify -format jpg $(FOLDER)/snapshot*.svg 
...
#	ffmpeg -i out.avi out.mp4 
	ffmpeg -r $(FRAMERATE) -f image2 -i $(FOLDER)/snapshot%08d.jpg -vcodec libx264 -pix_fmt yuv420p -strict -2 -tune animation -crf 15 -acodec aac $(MOVIENAME)
	#del snap*.jpg
# archival 
